...
Graph.prototype.update = function()
{
	...
	{	
		linksFeature2.forEach(function(lf2)				//""
		{
			...
			{
				if(lf2.target.features["Varietes"] == lf1.target.features["Varietes"])	//Si les deux liens ont un noeud cible de la même variete
				{
					//On crée un lien avec une valeur arbitraire
					this.addLink(lf2.source, lf2.target, linkId++, 10);
				}
			}
		}, this/*permet d'avoir accès à this dans un forEach*/);
	}, this);
